...
module.exports = function (opts) {
    ...
    var o = {
        ...
        //获取用户角色
        userRoles:function (userId, cb) {
            this.acl.userRoles(userId,cb);
        },

        //设置用户角色（可同时设置多个角色）
        addUserRoles:function (userId, roles, cb) {
            this.acl.addUserRoles(userId, roles, cb);
        },

        //删除用户角色（可同时删除多个角色）
        removeUserRoles:function (userId, roles, cb) {
            this.acl.removeUserRoles(userId, roles, cb);
        }
    };
    jm.enableEvent(o);
