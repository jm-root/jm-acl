...
var roleperSchema = require('../schema/roleper')();
...
var Acl = function (opts) {
    opts = opts || {};
    this.superRole = opts.superRole;
    this.prefix=opts.prefix||"";
    this.resource = jmcommon.dao({db:opts.db,modelName:this.prefix+'resource',schema:resourceSchema});
    this.org = jmcommon.dao({db:opts.db,modelName:this.prefix+'org',schema:orgSchema});
    this.roleper = jmcommon.dao({db:opts.db,modelName:this.prefix+'roleper',schema:roleperSchema});
    this.acl = new nodeacl(new nodeacl.mongodbBackend(opts.db,this.prefix),null, {
         buckets: {
             roles: 'roles',
             users: 'userroles'
         }
